...
```bash
longbridge financial-report TSLA.US                                     # 财务报表（利润表、资产负债表、现金流量表）
longbridge financial-report TSLA.US --kind IS --report af               # 年度利润表
longbridge financial-report TSLA.US --kind BS --report qf               # 季度资产负债表
longbridge valuation TSLA.US                                            # 估值快照：PE、PB、PS、股息率 + 同行对比
longbridge valuation TSLA.US --history                                  # 历史 PE 时间序列
longbridge valuation TSLA.US --history --indicator pb --range 5         # PB 历史，5 年区间
longbridge forecast-eps TSLA.US                                         # 分析师 EPS 预测共识
longbridge consensus TSLA.US                                            # 收入/利润/EPS 共识（含超预期/不及预期标注）
longbridge institution-rating TSLA.US                                   # 机构评级分布与目标价共识
longbridge institution-rating detail TSLA.US                            # 月度评级趋势与分析师准确率
longbridge shareholder AAPL.US                                          # 机构股东列表（含变动追踪）
longbridge shareholder AAPL.US --range inc --sort owned                 # 增持机构，按持股量排序
longbridge fund-holder AAPL.US                                          # 持有该标的的基金和 ETF（默认前 20）
longbridge fund-holder AAPL.US --count -1                               # 全部持仓机构
longbridge dividend AAPL.US                                             # 历史股息记录
longbridge dividend detail AAPL.US                                      # 股息分配方案详情
longbridge finance-calendar financial                                    # 即将发布的财经事件
longbridge finance-calendar report --symbol AAPL.US --symbol TSLA.US   # 指定标的财报日历
longbridge finance-calendar macrodata --star 3                          # 仅高重要性宏观经济事件
longbridge finance-calendar dividend --market US                        # 美股即将派息事件
longbridge exchange-rate                                                # 全市场汇率
```
