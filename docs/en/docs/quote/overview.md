...
1. Use private protocol and long connection mode to access, please refer to <a href="/docs/api/ws/protocol/overview" target="_blank">Binary Communication Protocol</a> for access method.
