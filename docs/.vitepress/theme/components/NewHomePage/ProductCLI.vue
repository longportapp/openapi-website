...
const features = [
  ...
  },
  {
    ...
    terminal: [
      ...
      { type: 'json',  text: '    "prev_close": "345.620",' },
...
.cli-subtitle { margin-top: 1.5rem; font-size: 0.95rem; font-weight: 600; color: var(--vp-c-text-2); line-height: 1.4; }
...
.cli-feat {
  ...
  font-size: 0.875rem; color: var(--vp-c-text-2); line-height: 1.4;
  background: transparent; border: 1px solid transparent;
  cursor: pointer; text-align: left; transition: all 0.2s;
}
.cli-feat:hover { background: var(--vp-c-bg); border-color: var(--vp-c-divider); }
.cli-feat.active { background: var(--vp-c-bg); border-color: var(--brand-color); color: var(--vp-c-text-1); }
...
.cli-install-tab:hover { color: var(--vp-c-text-2); }
.cli-install-tab.active { color: var(--brand-color); border-bottom-color: var(--brand-color); }
...
.cli-install-cmd code {
  font-size: 0.72rem; font-family: var(--vp-font-family-mono);
  color: var(--vp-c-text-2); flex: 1;
...
.cli-copy-btn {
  ...
  color: var(--vp-c-text-3); background: transparent; border: none; cursor: pointer; transition: all 0.2s;
}
.cli-copy-btn:hover { color: var(--brand-color); background: color-mix(in srgb, var(--brand-color) 8%, transparent); }
.cli-copy-btn:active { transform: scale(0.8); }
...
.cli-terminal.dark .cli-bar-title { color: #565869; }
.cli-terminal.dark .cli-theme-btn,
.cli-terminal.dark .cli-bar-copy { color: #565869; }
.cli-terminal.dark .cli-theme-btn:hover,
.cli-terminal.dark .cli-bar-copy:hover { color: #7aa2f7; }
.cli-terminal.dark .cli-body { color: #a9b1d6; }
.cli-terminal.dark .cli-line-cmd { color: #7aa2f7; }
.cli-terminal.dark .cli-line-data { color: #9ece6a; }
.cli-terminal.dark .cli-line-json { color: #e0af68; }
.cli-terminal.dark .cli-line-comment { color: #565869; }
.cli-terminal.dark .cli-cursor { color: #7aa2f7; }
...
.cli-terminal.light .cli-bar-title { color: #9a9aa8; }
.cli-terminal.light .cli-theme-btn,
.cli-terminal.light .cli-bar-copy { color: #9a9aa8; }
.cli-terminal.light .cli-theme-btn:hover,
.cli-terminal.light .cli-bar-copy:hover { color: #4078f2; }
.cli-terminal.light .cli-body { color: #383a42; }
.cli-terminal.light .cli-line-cmd { color: #4078f2; }
.cli-terminal.light .cli-line-data { color: #50a14f; }
.cli-terminal.light .cli-line-json { color: #c18401; }
.cli-terminal.light .cli-line-comment { color: #a0a1a7; }
.cli-terminal.light .cli-cursor { color: #4078f2; }
...
.cli-bar-title { flex: 1; text-align: center; font-size: 0.7rem; font-weight: 500; }
...
.cli-body {
  ...
  font-size: 0.875rem; line-height: 1.6; min-height: 14rem;
}
...
@media (max-width: 768px) {
  ...
  .cli-terminal-col { flex: none; width: 100%; }
}
</style>
