...
```bash
longbridge financial-report TSLA.US                                     # 財務報表（利潤表、資產負債表、現金流量表）
longbridge financial-report TSLA.US --kind IS --report af               # 年度利潤表
longbridge financial-report TSLA.US --kind BS --report qf               # 季度資產負債表
longbridge valuation TSLA.US                                            # 估值快照：PE、PB、PS、股息率 + 同業對比
longbridge valuation TSLA.US --history                                  # 歷史 PE 時間序列
longbridge valuation TSLA.US --history --indicator pb --range 5         # PB 歷史，5 年區間
longbridge forecast-eps TSLA.US                                         # 分析師 EPS 預測共識
longbridge consensus TSLA.US                                            # 收入/利潤/EPS 共識（含超預期/不及預期標注）
longbridge institution-rating TSLA.US                                   # 機構評級分佈與目標價共識
longbridge institution-rating detail TSLA.US                            # 月度評級趨勢與分析師準確率
longbridge shareholder AAPL.US                                          # 機構股東列表（含變動追蹤）
longbridge shareholder AAPL.US --range inc --sort owned                 # 增持機構，按持股量排序
longbridge fund-holder AAPL.US                                          # 持有該標的的基金和 ETF（預設前 20）
longbridge fund-holder AAPL.US --count -1                               # 全部持倉機構
longbridge dividend AAPL.US                                             # 歷史股息記錄
longbridge dividend detail AAPL.US                                      # 股息分配方案詳情
longbridge finance-calendar financial                                    # 即將發布的財經事件
longbridge finance-calendar report --symbol AAPL.US --symbol TSLA.US   # 指定標的財報日曆
longbridge finance-calendar macrodata --star 3                          # 僅高重要性宏觀經濟事件
longbridge finance-calendar dividend --market US                        # 美股即將派息事件
longbridge exchange-rate                                                # 全市場匯率
```
