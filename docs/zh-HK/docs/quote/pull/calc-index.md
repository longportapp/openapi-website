...
<CliCommand>
longbridge calc-index TSLA.US NVDA.US  # PE、PB、EPS 等核心指標
longbridge calc-index AAPL.US --index pe,pb,eps,turnover_rate  # 指定查詢的指標
longbridge calc-index TSLA.US --index pe,total_market_value  # 市值相關指標
</CliCommand>
